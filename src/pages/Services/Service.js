...
function Service() {
  return (
    <div className='service-parent'>
      ...
      <ServiceCard imgUrl={legal} title="Expert Representation for Your Property Needs" para="Experience expert legal representation with us. Our services include providing guidance on landlord and tenant law, assisting with property ownership disputes, and representing you in legal actions against negligent landlords. Trust us to navigate these complexities with skill and dedication." />
